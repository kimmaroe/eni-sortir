 ...
 */
final class Version20201021094020 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE event (id INT AUTO_INCREMENT NOT NULL, creator_id INT NOT NULL, state_id INT NOT NULL, campus_id INT NOT NULL, location_id INT DEFAULT NULL, city_id INT DEFAULT NULL, title VARCHAR(30) NOT NULL, date_start DATETIME NOT NULL, date_end DATETIME NOT NULL, max_registrations INT NOT NULL, description LONGTEXT DEFAULT NULL, date_created DATETIME NOT NULL, date_updated DATETIME DEFAULT NULL, date_registration_ended DATETIME NOT NULL, INDEX IDX_3BAE0AA761220EA6 (creator_id), INDEX IDX_3BAE0AA75D83CC1 (state_id), INDEX IDX_3BAE0AA7AF5D55E1 (campus_id), INDEX IDX_3BAE0AA764D218E (location_id), INDEX IDX_3BAE0AA78BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE event_cancelation (id INT AUTO_INCREMENT NOT NULL, event_id INT NOT NULL, reason LONGTEXT NOT NULL, date_canceled DATETIME NOT NULL, UNIQUE INDEX UNIQ_14060EB871F7E88B (event_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE location (id INT AUTO_INCREMENT NOT NULL, city_id INT NOT NULL, name VARCHAR(255) NOT NULL, street_number VARCHAR(50) DEFAULT NULL, street_name VARCHAR(100) DEFAULT NULL, lat NUMERIC(10, 7) DEFAULT NULL, lng NUMERIC(10, 7) DEFAULT NULL, date_created DATETIME NOT NULL, zip VARCHAR(5) DEFAULT NULL, INDEX IDX_5E9E89CB8BAC62AF (city_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE event_cancelation ADD CONSTRAINT FK_14060EB871F7E88B FOREIGN KEY (event_id) REFERENCES event (id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE event_cancelation DROP FOREIGN KEY FK_14060EB871F7E88B');
        ...
        $this->addSql('DROP TABLE event_cancelation');
